...
const RecallTransactionPage = () => {
  ...
  const handleRecallTransaction = () => {
    if (selectedTransaction) {
      console.log("Recalling transaction:", selectedTransaction);
      const recalledItems = selectedTransaction.items.map(item => ({
      ...
      navigate('/loop/orders', {
        state: {
          recalledTransaction: {
            ...
            orderPunched: selectedTransaction.orderPunched,
            paidStatus: selectedTransaction.paidStatus,
          },
        },
      });
    }
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, paddingBottom: 0.5 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            >
              Recall Transaction through Transaction ID:
            </Typography>
            <TextField
              value={searchTerm}
...
export default RecallTransactionPage;